...
@section('content')
     ...
     @foreach ($cateInfo as $v)
      <li><a href="{{url('/prolist/'.$v->cate_id)}}" value="{{$v->cate_id}}">@php echo str_repeat('-',$v['lv'])@endphp {{$v->cate_name}}</a></li>
   @endforeach
      <div class="clearfix"></div>
     </ul><!--pronav/-->
    ...
    <dl>
        ...
        <dd class="ip-text"><a href="{{url('/proinfo/'.$v->goods_id)}}">{{$v->goods_name}}</a><span>已售：77</span></dd>
